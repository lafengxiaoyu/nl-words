...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2026-02-07 | 2.3 | 更新全局最大ID为6844（完成C1 lesson-13数据录入） |
| 2026-02-07 | 2.2 | 更新全局最大ID为6717（完成C1 lesson-12数据录入） |
| 2026-02-07 | 2.1 | 更新全局最大ID为6567（完成C1 lesson-11数据录入） |
